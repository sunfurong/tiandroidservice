...
class AndroidserviceModule : public titanium::Proxy
{
public:
	explicit AndroidserviceModule(jobject javaObject);
...
private:
	...
	static v8::Handle<v8::Value> startApp(const v8::Arguments&);
	static v8::Handle<v8::Value> back(const v8::Arguments&);
	static v8::Handle<v8::Value> example(const v8::Arguments&);
	static v8::Handle<v8::Value> getServiceState(const v8::Arguments&);
